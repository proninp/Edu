...
namespace CodeWars._6kyu
{
    class TribonacciSequence
    {
         ...
         * [0, 0, 1, 1, 2, 4, 7, 13, 24, ...]
         * Well, you may have guessed it by now, but to be clear: you need to create a fibonacci function that given a signature array/list, returns the first n elements - signature
         * included of the so seeded sequence.
         * Signature will always contain 3 numbers; n will always be a non-negative number; if n == 0, then return an empty array and be ready for anything else which is not clearly specified ;)
         * If you enjoyed this kata more advanced and generalized version of it can be found in the Xbonacci kata
         * [Personal thanks to Professor Jim Fowler on Coursera for his awesome classes that I really recommend to any math enthusiast and for showing me this mathematical curiosity
         * too with his usual contagious passion :)]
         */
        public double[] Tribonacci(double[] signature, int n)
        {
            if (n == 0) return new double[0];
            List<double> list = signature.ToList();
            for (int i = 0; i < n; i++)
